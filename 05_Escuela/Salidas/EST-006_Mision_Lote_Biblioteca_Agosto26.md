...
|---------|-------|----------|
| [[00_Indice_fuentes\|Fuentes]] | 29 fichas | Todas de teoría de diseño. Cero de programación, level design, UX aplicado, producción o negocio |
| [[00_Indice_fundamentos\|Fundamentos]] | 5 libros | [[05_Fundamentos_de_experiencia_ludica]] declaraba **nueve misiones de profundización** en su tabla final. Ninguna corrida |
| [[00_Indice_juegos\|Juegos]] | **1 libro** | Solo [[01_Pong]]. El estante existe para que "hacé un juego de género X" traiga baseline sin pedirlo, y cubría un solo género |
