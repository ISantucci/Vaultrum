...
- Una branch/proyecto cerrado que se resolvió con conocimiento ya existente en el Core.

---

## Transformación que realiza

- El Encargado de Commits revisa lo hecho buscando fricciones: ¿alguna nota del Core estuvo confusa? ¿faltó un ejemplo? ¿algo se aplicó distinto a como estaba documentado?
...
No inventar aprendizajes para justificar el paso. No tocar el Core por tocar (principio 6). No confundir "lo que pasó en el proyecto" con criterio reutilizable.
