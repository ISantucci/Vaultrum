...
Finalmente transforma la idea en salidas productivas registrables.
...
Estos trabajos se realizan mediante flujos de trabajo preseteados.

Cada agente del área implementa los flujos que corresponden a su responsabilidad, sin absorber tareas de otros agentes o áreas.
...
Puede ordenar una necesidad de diseño, pero no reemplazar el criterio del área de Technical Game Design.

No debe documentar conocimiento técnico profundo.  
Puede producir requerimientos, decisiones productivas o lineamientos de planificación, pero no reemplazar al área de Documentación cuando algo debe quedar registrado como conocimiento mantenible del vault.

No debe auditar el cierre final de calidad.  
Puede detectar riesgos de alcance, planificación o consistencia, pero no reemplaza una revisión formal de calidad.

No debe crear contenido público.  
Puede ordenar la intención, el objetivo o el requerimiento de comunicación, pero no reemplazar al área de Contenido Público.
